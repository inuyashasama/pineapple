...
public class UserPoint {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFrozenPoints() == null ? other.getFrozenPoints() == null : this.getFrozenPoints().equals(other.getFrozenPoints()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFrozenPoints() == null) ? 0 : getFrozenPoints().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", frozenPoints=").append(frozenPoints);
